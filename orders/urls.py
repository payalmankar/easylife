...
urlpatterns = [
     ...
     path('get_counts_as_date/', views.get_counts_as_date, name='get_counts_as_date'),
     # path('update_orders_count/', cart_template_tags.all_orders_count , name="all_orders_count"),
]    
